        ...
        <Tabs defaultValue="services" className="w-full">
          ...
          <TabsContent value="services" className="mt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {/* Service 1 */}
              <motion.div 
                className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-[#FF7420] group hover:-translate-y-2 transition-transform duration-300"
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-[#191A19]">What Our Clients Say</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Hear from our satisfied clients about their experience working with Vithanage Group.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#191A19]">Samantha Perera</h4>
                  <p className="text-sm text-gray-500">Homeowner</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                "The team at Vithanage Group transformed our home with beautiful custom woodwork. Their attention to detail and quality craftsmanship exceeded our expectations."
              </p>
              <div className="flex text-[#FF7420]">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#191A19]">Rajitha Fernando</h4>
                  <p className="text-sm text-gray-500">Business Owner</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                "Their construction management system has revolutionized how we track our projects. The real-time updates and analytics have improved our efficiency by 40%."
              </p>
              <div className="flex text-[#FF7420]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="font-bold text-[#191A19]">Dinesh Gunawardena</h4>
                  <p className="text-sm text-gray-500">Architect</p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                "The quality of timber and construction materials from Vithanage Group is consistently excellent. Their inventory management system makes ordering and tracking supplies seamless."
              </p>
              <div className="flex text-[#FF7420]">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-[#FF7420]">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/quotations" 
              className="px-8 py-3 bg-white text-[#FF7420] rounded-lg hover:bg-gray-100 transition-colors font-medium shadow-lg hover:shadow-xl"
            >
              Get Started
            </Link>
            <Link 
              href="/contact" 
              className="px-8 py-3 bg-[#191A19] text-white rounded-lg hover:bg-gray-800 transition-colors font-medium shadow-lg hover:shadow-xl"
            >
              Contact Us
            </Link>
          </div>
      ...
      <footer className="py-12 px-4 md:px-8 lg:px-16 bg-gray-800 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Vithanage Group</h3>
              <p className="text-gray-400 mb-4">A modern digital platform for construction, woodcraft, and timber sales.</p>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-400 hover:text-[#FF7420]">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/Construction/Cfront" className="text-gray-400 hover:text-white">Construction Management</Link></li>
                <li><Link href="/services/quotation" className="text-gray-400 hover:text-white">Quotation System</Link></li>
                <li><Link href="/timber" className="text-gray-400 hover:text-white">Inventory Management</Link></li>
                <li><Link href="/services/payroll" className="text-gray-400 hover:text-white">Payroll Management</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">123 Construction Ave, Colombo, Sri Lanka</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="text-gray-400">info@vithanagegroup.com</span>
                </li>
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
