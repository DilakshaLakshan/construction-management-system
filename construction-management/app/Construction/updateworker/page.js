...
export default function LabourUpdate() {
  ...
  // Grab existing values from query params
  ...
  const handleSubmit = async (e) => {
    ...
    router.push("/Construction/workers-list");
  };

  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-3xl mx-auto bg-white p-6 shadow-md rounded-md">
        <h2 className="text-2xl font-bold mb-4">Update Worker</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-2">
            <button
              type="button"
              onClick={() => router.push("/Construction/workers-list")}
